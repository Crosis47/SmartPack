...
## Upstream baseline: original MinecraftCondensePlugin

The original upstream project was a small Bukkit-style plugin with a minimal README, a simple `/condense` command, a small Maven project, and a package rooted under `rd156.minecraft.condense`.
